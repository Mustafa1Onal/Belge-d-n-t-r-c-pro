        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-gray-900 tracking-tight">Dönüştürücü<span className="text-brand-600">Pro</span></span>
            </div>
            
            <nav className="hidden md:flex space-x-8">
              <button className="text-gray-500 hover:text-gray-900 font-medium">Nasıl Çalışır?</button>
              <button className="text-gray-500 hover:text-gray-900 font-medium">SSS</button>
              <button className="text-gray-500 hover:text-gray-900 font-medium">İletişim</button>
            </nav>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="text-center max-w-3xl mb-12">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4 leading-tight">
            Belgelerinizi <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Saniyeler İçinde</span> Dönüştürün
          </h1>
          <p className="text-lg text-gray-600">
            Word dosyalarını PDF'e, PDF dosyalarını Word'e ücretsiz ve güvenli bir şekilde dönüştürün.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 max-w-7xl w-full">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-gray-900 mb-2">Hızlı Dönüştürme</h3>
            <p className="text-gray-500 text-sm">Gelişmiş algoritmalarımız sayesinde dosyalarınız saniyeler içinde hazır.</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center text-green-600 mb-4">
              <i className="fa-solid fa-shield-halved text-xl"></i>
            </div>
            <h3 className="font-bold text-gray-900 mb-2">Güvenli İşlem</h3>
            <p className="text-gray-500 text-sm">Dosyalarınız sunucularımızda saklanmaz, işlem sonrası otomatik silinir.</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center text-purple-600 mb-4">
              <i className="fa-solid fa-microchip text-xl"></i>
            </div>
            <h3 className="font-bold text-gray-900 mb-2">AI Destekli</h3>
            <p className="text-gray-500 text-sm">Gemini AI teknolojisi ile belgelerinizi analiz edebilir ve iyileştirebilirsiniz.</p>
          </div>
        </div>
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">© 2024 Dönüştürücü Pro. Tüm hakları saklıdır.</p>
            <div className="flex gap-4">
              <a href="#" className="text-gray-400 hover:text-gray-600"><i className="fa-brands fa-twitter"></i></a>
              <a href="#" className="text-gray-400 hover:text-gray-600"><i className="fa-brands fa-github"></i></a>
            </div>
          </div>
        </div>
      </footer>
