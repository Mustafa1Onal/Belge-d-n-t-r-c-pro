...
const DonationBanner: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white shadow-lg relative z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3 flex-1">
          ...
          <p className="text-sm font-medium leading-relaxed">
            Bu site sizin gibi insanların bağışları ile ücretsiz olarak kullanılabiliyor.
            <span className="block mt-1 sm:mt-0 sm:inline sm:ml-2 text-yellow-400 font-mono text-xs sm:text-sm bg-gray-700/50 px-2 py-1 rounded select-all cursor-pointer" title="Kopyalamak için tıklayın" onClick={() => navigator.clipboard.writeText("bc1q2psekc70zn2v9k7p04gc42xz7wg5kayq44wze3")}>
